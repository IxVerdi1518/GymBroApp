          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Image(
                  image: AssetImage('assets/dumbbell-bicep-curl.gif'),
                ),
              ),
              ...
              Container(
                width: size.width * 0.7,
                child: const Text(
                    '1. De pie con una mancuerna en cada mano y los codos tocando los costados del torso.',
                    textAlign: TextAlign.justify,
              ...
              Container(
                width: size.width * 0.7,
                child: const Text(
                    '2. Manteniendo inmóvil la parte superior del brazo, doble el peso correcto con la palma hacia adelante. Levanta la mancuerna hacia el hombro hasta que el bíceps esté completamente contraído. Mantén esta posición por un segundo y aprieta el bíceps.',
                    textAlign: TextAlign.justify,
                    style: TextStyle(fontSize: 18.0, letterSpacing: -1.1)),
              ),
              Container(
                width: size.width * 0.7,
                child: const Text(
                    '3. Baja las mancuernas y repite el mismo movimiento con ambos brazos.',
                    textAlign: TextAlign.justify,
                    style: TextStyle(fontSize: 18.0, letterSpacing: -1.1)),
              ),
              ElevatedButton(
