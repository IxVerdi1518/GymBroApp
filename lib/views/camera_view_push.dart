...
class CameraViewPush extends StatefulWidget {
  CameraViewPush(
      {Key? key,
  ...
  @override
  State<CameraViewPush> createState() => _CameraViewState();
}

class _CameraViewState extends State<CameraViewPush> {
  ...
  @override
  void didUpdateWidget(covariant CameraViewPush oldWidget) {
    if (widget.customPaint != oldWidget.customPaint) {
      ...
      if (p1 != null && p2 != null && p3 != null && p4 != null && p5 != null && p6 != null) {
        final rtaPAngle = utils.angle(p1!, p2!, p3!);
        final ltaPAngle = utils.angle(p4!, p5!, p6!);

        final rtaP = utils.isPushUp(rtaPAngle, bloc.state);
        final ltaP = utils.isPushUp(ltaPAngle, bloc.state);

        print('Angulo: ${rtaPAngle.toStringAsFixed(2)}');
        print('Angulo: ${ltaPAngle.toStringAsFixed(2)}');
