...
class CameraViewPress extends StatefulWidget {
  CameraViewPress(
      {Key? key,
  ...
  @override
  State<CameraViewPress> createState() => _CameraViewState();
}

class _CameraViewState extends State<CameraViewPress> {
  ...
  @override
  void didUpdateWidget(covariant CameraViewPress oldWidget) {
    if (widget.customPaint != oldWidget.customPaint) {
      ...
      //verificar
      if (p1 != null && p2 != null && p4 != null && p5 != null && p7 != null && p10 != null) {
